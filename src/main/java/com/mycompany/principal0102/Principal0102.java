...
package com.mycompany.principal0102;

/**
 *
 * @author Jose
 */
public class Principal0102 {
    ...
    public static void main(String[] arga) {
        ...
        System.out.println("El empleado " + empleado1.nombre + " tiene un ingreso neto de: " 
        ...
        System.out.println("El empleado " + empleado2.nombre + " tiene un ingreso neto de: " 
        ...
        System.out.println("El empleado " + empleado3.nombre + " tiene un ingreso neto de: " 
